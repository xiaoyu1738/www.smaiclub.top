...
const VolumeList: React.FC<VolumeListProps> = ({ novel, onSelectVolume, onBack }) => {
  return (
              ...
              >
                <div className="flex items-center gap-4 truncate">
                  ...
                  <div className="truncate">
                    <h3 className="font-semibold text-lg truncate">{volume.title}</h3>
                  </div>
                </div>
                <span className="text-sm text-gray-400 hover:text-white flex-shrink-0 ml-4">立即阅读</span>
              </div>
            ))}
          </div>
        </main>
